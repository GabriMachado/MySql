...
SELECT * FROM tb_produtos WHERE preco IN (5, 10, 15, 1.50);
...
SELECT categoria_id, AVG (preco) AS Média_Preco FROM tb_produtos GROUP BY categoria_id ORDER BY Média_Preço;
